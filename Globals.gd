...
var minecraft_map_colors = [
	...
	[Color(255, 252, 245), "Diorite (stairs; slab; wall), Polished Diorite (stairs; slab), Birch Log (side), Quartz Block (all variants; all slabs; all stairs), Sea Lantern, Target"],
	...
	[Color(25, 25, 25), "Black Wool, Black Carpet, Black Shulker Box, Black Bed (foot), Black Stained Glass, Black Glazed Terracotta, Black Concrete, Black Concrete Powder, Black Candle, Obsidian, End Portal, Dragon Egg, Coal Block, End Gateway, Basalt, Polished Basalt, Smooth Basalt, Block of Netherite, Ancient Debris, Crying Obsidian, Respawn Anchor, Blackstone (all variants; all stairs; all slabs; all walls), Gilded Blackstone, Sculk, Sculk Vein, Sculk Catalyst, Sculk Shrieker"],
	...
	[Color(129, 86, 49), "Podzol, Spruce Planks, Spruce Log (vertical), Stripped Spruce Log, Spruce Wood, Stripped Spruce Wood, Spruce Sign, Spruce Pressure Plate, Spruce Trapdoor, Spruce Stairs, Spruce Slab, Spruce Fence Gate, Spruce Fence, Spruce Door, Oak Log (side), Jungle Log (side), Campfire, Soul Campfire, Mangrove Log (side), Mangrove Roots, Muddy Mangrove Roots"],
